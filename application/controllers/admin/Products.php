...
class Products extends CI_Controller
{
	...
	public function index()
	{
		...
		$pesan['flash'] = $this->session->flashdata('product_flash');

		$this->load->view('templates/admin_header', $params);
		$this->load->view('templates/admin_sidebar', $pesan);
		$this->load->view('admin/products', $products, $pesan);
	...
	public function view($id = 0)
	{
		if ($this->product->is_product_exist($id)) {
			...
			$this->load->view('admin/detail_product', $product);
			$this->load->view('templates/admin_footer');
		} else {
			show_404();
		}

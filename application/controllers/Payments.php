...
class Payments extends CI_Controller
{
	...
	{
		$params['title'] = 'My Payment';

		$config['base_url'] = site_url('customer/payments');
		...
		$this->load->view('customer/payment', $payments);
	...
	public function confirm()
	{
		...
		$this->load->view('templates/header', $params);
		$this->load->view('customer/confirm', $payments);
		$this->load->view('templates/footer');
	}
	...
	public function view($id = 0)
	{
		if ($this->payment->is_payment_exist($id)) {
			...
			$this->load->view('templates/header', $params);
			$this->load->view('customer/detail_payment', $payment);
			$this->load->view('templates/footer');
		} else {
			show_404();
		}

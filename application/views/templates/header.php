			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					<a href="#" class="header-wrapicon1 dis-block">
						<img src="<?= base_url() ?>assets/images/avatar.png" class="header-icon1 img-profile rounded-circle" alt="ICON">
					</a>
				...
				<?php if ($this->session->userdata('nama')) { ?>
					<li><a href="<?= base_url('auth/logout') ?>">Logout</span></a></li>
				<?php
				} else { ?>
				...
				<?php } ?> 
					...
					<div class="header-wrapicon2">
						...
						<span class="header-icons-noti" style="background-color: red;"><?php $keranjang = $this->cart->total_items() ?> <?= $keranjang ?></span>
						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<?php echo anchor('dashboard/detail_keranjang/'.$keranjang, '<div class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">View Cart</div>') ?>
								</div>

						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50 h-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
									<img src="<?= base_url() . '/assets/uploads/products/' . $best_deal->picture_name; ?>" alt="IMG-PRODUCT">
									...
									<div class="block2-overlay trans-0-4">
										...
										<div class="block2-btn-addcart w-size1 trans-0-4">
											<?php if ($best_deal->stock > 0) : ?>
												<a href="#" class="add-cart add-to-chart flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4 mb-2" data-sku="<?php echo $best_deal->sku;; ?>" data-name="<?php echo $best_deal->name; ?>" data-price="<?php echo ($best_deal->current_discount > 0) ? ($best_deal->price - $best_deal->current_discount) : $best_deal->price; ?>" data-id="<?php echo $best_deal->id; ?>">Add to Cart</a>
											<?php else : ?>
											...
											<?= anchor('shop/product/' . $best_deal->id . '/' . $best_deal->sku, '<button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4 mb-2">
												Detail
											</button>') ?>
								...
								<div class="block2-txt p-t-20">
									...
									<?php if ($best_deal->current_discount > 0) : ?>
										<span class="block2-oldprice m-text7 p-r-5">
											...
											Rp <?php echo format_rupiah($best_deal->price); ?>
										</span>

										<span class="block2-newprice m-text8 p-r-5">
											<!--Price setelah di diskon -->
											Rp <?php echo format_rupiah($best_deal->price - $best_deal->current_discount); ?>
										</span>
									...
									<?php if ($best_deal->current_discount > 0) : ?>
										<span class="block2-name dis-block s-text3 mt-1" style="color: red;">
											Discount <?php echo count_percent_discount($best_deal->current_discount, $best_deal->price, 0); ?>%
										</span>
									<?php endif; ?>

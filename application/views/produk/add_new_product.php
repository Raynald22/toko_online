				...
				<div class="col-lg-6 col-5 text-right">
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item"><a href="<?php echo site_url('admin/products'); ?>">Product</a></li>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="form-control-label" for="pakcage">Category :</label>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<small class="text-muted">Choose PNG or JPG with maximal size 2MB</small>
					</div>
				</div>
